...
<html lang="en">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="tipologiagrafica.php">Tipologias</a>
    ...
    <body>
    <div class="column">
        <h2 class="text-center mt-4 mb-3">Estadisticas por tipologias </a></h2>
        <div class="container-fluid">
            <div class="row">
              
               
          <!-- Cajas que continesn el titulo y las graficas  -->
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <div class="card mt-4">
...
$(document).ready(function(){
    ...
    $('#submit_data').click(function(){
        ...
        // se llama los datos del archivo datatipologia por medio de ajax
        $.ajax({
            url:"../../controllers/data/tipologia/datatipologia.php",
            method:"POST",
