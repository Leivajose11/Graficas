                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="../tipologia/tipologiagrafica.php">Tipologias</a>
                        <a class="collapse-item" href="subtipologiagrafica.php">Subtipologias</a>     
...
$(document).ready(function(){
    ...
    $('#submit_data').click(function(){
        ...
        $.ajax({
            url:"../../controllers/data/subtipologia/datasubtipologia.php",
            method:"POST",
    ...
    function makechart()
    {
        $.ajax({
            ...
            {
                var incidentesubtipologia = [];
                var total = [];
                var color = [];

                for(var count = 0; count < data.length; count++)
                {
                    incidentesubtipologia.push(data[count].incidentesubtipologia);
                    total.push(data[count].total);
                    color.push(data[count].color);
                }

                var chart_data = {
                    labels:incidentesubtipologia,
                    datasets:[
                        {
                            label:'Subtipologias',
