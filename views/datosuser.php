...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="datosuser.php">
  ...
  <body >
   ...
   <div>   
      ...
      <form name="f1" method="POST" action="../insertarincidente2.php">
   ...
   <script  src="../js/script.js"></script> </div>
    ...
    <br>
       ...
       <textarea  type="text" name="incidentedescripcioncomplementaria" class="form-control"></textarea>
        ...
        <div class="card col-sm-4" class="card col-sm-5" >
        <label>Nota de policia:</label>
        <textarea  type="text" name="incidentenotapolicia" class="form-control"></textarea>
        </div>
        <br>
...
include '../consultaunidad.php'
 ?>
  ...
  <div class="card-body" >
     ...
     <form  name="form1" method="POST" action="../insertarunidad2.php">
