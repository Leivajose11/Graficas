                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../despacho/despachografica.php">Despachos</a>
                         <a class="collapse-item" href="generografica.php">Genero</a>
...
$(document).ready(function(){
    ...
    $('#submit_data').click(function(){
        ...
        $.ajax({
            url:"../../controllers/data/genero/datagenero.php",
            method:"POST",
    ...
    function makechart()
    {
        $.ajax({
            ...
            success:function(data)
            {
                ...
                {
                    incidentegenero.push(data[count].incidentegenero);
                    total.push(data[count].total);
                    color.push(data[count].color);
                }

                var chart_data = {
                    labels:incidentegenero,
                    datasets:[
                        {
                            label:'Generos',
