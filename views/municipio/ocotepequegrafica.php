                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="../tipologia/tipologiagrafica.php">Tipologias</a>
                        ...
                        <a class="collapse-item" href="../municipio/copangrafica.php">Copan</a>
                         <a class="collapse-item" href="ocotepequegrafica.php">Ocotepeque</a>
...
$(document).ready(function(){
    ...
    $('#submit_data').click(function(){
        ...
        $.ajax({
            url:"../../controllers/data/municipio/dataocotepeque.php",
            method:"POST",
    ...
    function makechart()
    {
        $.ajax({
            ...
            {
                var incidentemunicipio = [];
                var total = [];
                var color = [];

                for(var count = 0; count < data.length; count++)
                {
                    incidentemunicipio.push(data[count].incidentemunicipio);
                    total.push(data[count].total);
                    color.push(data[count].color);
                }

                var chart_data = {
                    labels:incidentemunicipio,
                    datasets:[
                        {
                            label:'Ocotepeque',
