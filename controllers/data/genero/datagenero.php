...
if(isset($_POST["action"]))
{
	...
	{
		$query = "
		SELECT incidentegenero, COUNT(ID) AS Total 
		FROM incidente WHERE incidentegenero = 'Hombre' or incidentegenero = 'Mujer' or incidentegenero = 'Indeterminado' or incidentegenero = 'Niño'
		 GROUP BY incidentegenero
		...
		{
			$data[] = array(
				'incidentegenero'		=>	$row["incidentegenero"],
				'total'			=>	$row["Total"],
