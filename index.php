                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="views/tipologia/tipologiagrafica.php">Tipologias</a>
                        ...
                        <a class="collapse-item" href="views/subtipologia/subtipologiagrafica.php">Subtipologias</a>
                         
                        <a class="collapse-item" href="views/departamento/departamentografica.php">Departamentos</a>
                         
                         <h6 class="collapse-header">Municipios:</h6>
                        <a class="collapse-item" href="views/municipio/copangrafica.php">Copan</a>
                         <a class="collapse-item" href="views/municipio/ocotepequegrafica.php">Ocotepeque</a>
                          <a class="collapse-item" href="views/municipio/lempiragrafica.php">Lempira</a>
                           <hr class="sidebar-divider">
                        <a class="collapse-item" href="views/despacho/despachografica.php">Despachos</a>
                         <a class="collapse-item" href="views/genero/generografica.php">Genero</a>
                        <a class="collapse-item" href="views/arma/armagrafica.php">Arma</a>
                    </div>
                </div>
            </li>
